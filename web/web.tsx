...
const App = () => {
  ...
  return <>
    ...
    <footer>
      ...
      <nav>
        <a href={require('./terms-v0-2.doc')} download>Terms &amp; Conditions</a>
        <a href={require('./privacy-v0-2.doc')} download>Privacy Policy</a>
        <a href={require('./disclaimer-v0-2.doc')} download>Disclaimer</a>
      </nav>
